import { Script, ISimplifiedNode, EventSubscriber, IEventNames, IEvents, RPCSendableMessage } from '.';
...
export declare abstract class ScriptableScene<Props = {}, State = {}> extends Script {
    ...
    getEthereumProvider(): Promise<{
        send(): void;
        sendAsync(message: RPCSendableMessage, callback: (error: Error, result?: any) => void): void;
    }>;
}
